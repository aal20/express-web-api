...
module.exports = function(app){
    ...
    app.get('/dog', function(req, res){
        Dog.find(function(err, dogs){
            ...
            setTimeout(function(){
                res.json({info: 'dogs found successfully', data: dogs});                     
           }, 5000); //making this take 5 secs to simulate a real request and compare the time it takes once it's cached in redis
        });
    });
    ...
    app.get('/dog/:id', function(req, res){
        Dog.findById(req.params.id, function(err, dog){
            ...
            if(dog){
                res.json({info: 'dogfound successfully', data: dog});               
            }else{
